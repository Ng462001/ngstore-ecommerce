...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (tab && ["profile", "address", "password", "requests", "reviews"].includes(tab)) {
      setActiveTab(tab);
    }
  }, [location.search]);
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      editedUser.name.trim().length === 0 ||
      editedUser.phone.trim().length === 0
    ) {
    ...
    <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="font-heading text-3xl sm:text-4xl font-semibold text-text-primary mb-2">
            My Account
          </h1>
            ...
            <div className="bg-surface rounded-2xl shadow-soft p-4 sm:p-6 sticky top-24 border border-border-light">
              ...
              <nav className="flex lg:flex-col overflow-x-auto gap-2 lg:gap-0 lg:space-y-1.5 mb-4 sm:mb-6 pb-2 lg:pb-0 no-scrollbar">
                <button
                  ...
                  className={`shrink-0 lg:w-full text-left px-4 py-2.5 sm:py-3 rounded-xl transition-all duration-200 ${
                    activeTab === "profile"
              ...
              <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                <div className="bg-gradient-to-r from-cyan-500 to-blue-600 px-6 py-4">
                  ...
                  <p className="text-cyan-100 text-sm">
                    Track your tickets and return requests
                  </p>
                </div>
                <div className="p-4 sm:p-6">
                  <UserRequests
                    requestId={new URLSearchParams(location.search).get(
                      "requestId",
                    )}
                  />
                </div>
