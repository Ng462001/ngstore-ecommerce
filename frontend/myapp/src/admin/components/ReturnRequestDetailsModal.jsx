          ...
          <Grid item xs={12} md={4}>
            <Paper sx={{ p: 3, borderRadius: 2, height: "100%" }}>
              ...
              <List dense>
                ...
                <ListItem>
                  <ListItemIcon>{typeConfig.icon}</ListItemIcon>
                  {editMode ? (
                ...
                <ListItem>
                  <ListItemIcon>{statusConfig.icon}</ListItemIcon>
                  {editMode ? (
                    <FormControl fullWidth size="small">
                      <Select
                ...
                {editMode ? (
                  ...
                  <Paper
                    ...
                    sx={{
                      ...
                      bgcolor: "grey.50",
                      minHeight: 80,
                      fontStyle: displayRequest.adminDetails?.note
                        ? "normal"
                        : "italic",
                      color: displayRequest.adminDetails?.note
                        ? "text.primary"
                        : "text.secondary",
                    }}
                  >
                    <Typography variant="body2">
                      {displayRequest.adminDetails?.note ||
                        "No notes added yet."}
                    </Typography>
                  </Paper>
                )}
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <Paper sx={{ p: 3, borderRadius: 2 }}>
          ...
          {!request.items || request.items.length === 0 ? (
            <Alert severity="info">No items found in this request.</Alert>
          ) : (
            <TableContainer>
              <Table>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <Paper sx={{ p: 3, borderRadius: 2 }}>
          <Typography
            ...
            sx={{ display: "flex", alignItems: "center", gap: 1, mb: 3 }}
          >
            <AttachFile /> Proof Images & Attachments (
