...
const AdminReturns = () => {
  ...
  const confirmDelete = async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/return-exchange/admin/${requestToDelete}`,
        {
          method: "DELETE",
          headers: {
  ...
  const fetchRequests = async () => {
    try {
      setLoading(true);
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/return-exchange/admin/all`,
        {
          headers: {
            Authorization: `Bearer ${userInfo.token}`,
          },
  ...
  const handleUpdateStatus = async (requestId, updateData) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/return-exchange/admin/${requestId}/status`,
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <Typography variant="body2" sx={{ color: "#6B6862", mt: 0.5 }}>
            Manage return and exchange requests ({filteredRequests.length}{" "}
            requests)
          </Typography>
        </div>
                    ...
                    {paginatedRequests.map((request) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <Typography
                            variant="body2"
                            sx={{ color: "#B8925A", fontWeight: 700 }}
                          >
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete this return/exchange request? This
