...
orderSchema.methods.getStatusTimeline = function () {
  ...
  if (this.processingAt)
    timeline.push({ status: "Processing", date: this.processingAt });
  if (this.shippedAt)
    timeline.push({ status: "Shipped", date: this.shippedAt });
  if (this.outForDeliveryAt)
    timeline.push({ status: "Out for delivery", date: this.outForDeliveryAt });
  if (this.deliveredAt)
    timeline.push({ status: "Delivered", date: this.deliveredAt });
  if (this.cancelledAt)
    timeline.push({ status: "Cancelled", date: this.cancelledAt });
  if (this.returnedAt)
    timeline.push({ status: "Returned", date: this.returnedAt });
  if (this.refundedAt)
    timeline.push({ status: "Refunded", date: this.refundedAt });
